...
p1<-ggplot(sub_tib1, aes(Start/1000000, fct_rev(NonB), fill=fct_rev(NonB))) +
  geom_rect(data=sub_tib1 %>% filter(NonB=="APR"), aes(xmin=Cen_start/1000000, ymin=7.55, ymax=7.6, xmax=Cen_end/1000000), color="red", linewidth=3, inherit.aes = FALSE) +
...
pcomb
# Save to figure 
outfile<-"plots/FigS15_Bornean_orangutan_chr10.png"
